<div class="w-100 d-flex flex-column">
    ...
    ?>
    <div class="collapse d-flex flex-column mt-2" id="create_div">

        <!-- форма создания -->
        <form action="index.php" method="POST" class="input-group mx-auto">
    ...
    <div class="w-100 p-0 fixed-bottom" style="height: 70px;">
        ...
        <a class="btn btn-outline-secondary" data-bs-toggle="collapse" role="button" aria-expanded="false" href="#create_div" style="color:white;text-decoration: none;">+</a>
